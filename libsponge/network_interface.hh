...
class NetworkInterface {
  private:
    ...
    std::unordered_map<uint32_t, EthernetAddress> _mapping{};
    std::unordered_map<uint32_t, size_t> _timing{};
    std::unordered_map<uint32_t, size_t> _arpRequest{};
    std::vector<InternetDatagram> _datagramQue{};
    std::vector<uint32_t> _dstQue{};
